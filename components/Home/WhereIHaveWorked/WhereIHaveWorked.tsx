...
import Pekerjaan from "./Descriptions/Pekerjaan";
export default function WhereIHaveWorked() {
  ...
  const [DescriptionJob, setDescriptionJob] = React.useState("Pekerjaan");
  return (
...
const CompaniesBar = props => {
  const [barPosition, setBarPosition] = React.useState<Number>(0); // Green bar position, 44px per button
  ...
  return (
    ...
    >
      {/* // ? left bar Holder, stretches to the height of the buttons column */}
      <div
        className=" hidden md:block bg-gray-500 relative h-0.5 w-34 md:w-0.5 self-stretch
      ...
      <div className="flex flex-col md:order-2 order-1 space-y-1 pl-8 md:pl-0 ">
        <div className="flex flex-row md:flex-col">
          <CompanyButton
            ...
            CompanyName="Pekerjaan"
            BarPosition={0}
            BarAvobePosition={1}
            DescriptionJob="Pekerjaan"
