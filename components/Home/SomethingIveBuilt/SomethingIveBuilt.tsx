    ...
    >
      ...
      <div className="flex flex-col   xl:space-y-36 space-y-8 md:space-y-28">
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96  ">
          ...
          >
            <div className="relative rounded w-full h-full col-start-6 col-span-7 ">
              <a href="https://cek-kodam-xi.vercel.app/" target={"_blank"} rel="noreferrer">
                <div
                  className="absolute w-full h-full rounded bg-AAprimary 
           transition-opacity opacity-60 hover:opacity-0 hover:cursor-pointer duration-300"
                ></div>
              ...
              <Img src={"/cekkodam.png"} alt={"Project Screen shot"} className={`w-full rounded h-full `} />
            </div>
          </div>
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            <div className="absolute w-full h-full bg-opacity-70 z-0 md:order-2">
              <div className="relative w-full h-full">
                <div className="absolute w-full h-full bg-AAprimary opacity-50 z-10"></div>
                <div className="absolute w-full h-full bg-AAprimary opacity-80 z-10"></div>
                <Img src={"/cekkodam.png"} alt={"Project Screen shot"} className={`w-full h-full`} />
              </div>
            </div>
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left ">
                  <span className="text-AAsecondary">Web Cek Kodam</span>, merupakan
                   aplikasi website yang bertujuan untuk memunculkan nama nama kodam/hewan random pick, 
                   berdasarkan nama yang di input oleh user
                </p>
              </div>
              <ul
                className="flex flex-wrap w-full text-gray-300 md:text-gray-400
        ...
        <div data-aos="fade-up" className="relative  md:grid md:grid-cols-12 w-full md:h-96">
          ...
          >
            <div className="relative rounded w-full h-full col-span-7 ">
              <a href="https://love-meter-coral.vercel.app/" target={"_blank"} rel="noreferrer">
                <div
                  // onClick={}
                  className="absolute w-full h-full rounded bg-AAprimary 
           transition-opacity opacity-50 hover:opacity-0 hover:cursor-pointer duration-300"
              ...
              <Img src={"/lovemeter.png"} alt={"Project Screen shot"} className={`w-full rounded h-full `} />
            </div>
          </div>
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            <div className="absolute w-full h-full bg-opacity-70 z-0">
              <div className="relative w-full h-full">
                <div className="absolute w-full h-full bg-AAsecondary opacity-10 z-10"></div>
                <div className="absolute w-full h-full bg-AAprimary opacity-80 z-10"></div>
                <Img src={"/lovemeter.png"} alt={"Project Screen shot"} className={`w-full h-full `} />
              </div>
            </div>
            <div className="absolute w-full   rounded  ml-4 mt-2  text-end pr-8">
              <div className="w-full"></div>
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right">
                <span className="text-AAsecondary text-base">Web Love Meter</span>
                , merupakan aplikasi website yang akan memunculkan presentase kecocokan dari 2 nama yang di input oleh user,
                web ini dikemas dalam tampilan lovely
                </p>
              </div>
              <ul
                className="flex flex-wrap w-full text-gray-300 md:text-gray-400
        ...
        <div data-aos="fade-up" className="relative md:grid md:grid-cols-12 w-full md:h-96  ">
          ...
          >
            <div className="relative rounded w-full h-full col-start-6 col-span-7 ">
              <a href="https://forwardinapp.vercel.app/" target={"_blank"} rel="noreferrer">
                <div
                  className="absolute w-full h-full rounded bg-AAprimary 
           transition-opacity opacity-60 hover:opacity-0 hover:cursor-pointer duration-300"
                ></div>
              ...
              <Img src={"/forwardin.png"} alt={"Project Screen shot"} className={`w-full rounded h-full `} />
            </div>
          </div>
          ...
          <div className=" md:absolute py-4  md:grid md:grid-cols-12 w-full h-full  content-center ">
            ...
            <div className="absolute w-full h-full bg-opacity-70 z-0 md:order-2">
              <div className="relative w-full h-full">
                <div className="absolute w-full h-full bg-AAprimary opacity-50 z-10"></div>
                <div className="absolute w-full h-full bg-AAprimary opacity-80 z-10"></div>
                <Img src={"/forwardin.png"} alt={"Project Screen shot"} className={`w-full h-full`} />
              </div>
            </div>
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left ">
                  <span className="text-AAsecondary">Forwardin</span>, merupakan
                   aplikasi website yang bertujuan pengelolaan pesan yang di desain sedimikian rupa untuk memudahkan pengguna mengelola
                   data pesan yang mereka miliki, ini adalah project front end web dev yang merupakan tugas seleksi magang
                </p>
              </div>
              <ul
                className="flex flex-wrap w-full text-gray-300 md:text-gray-400
